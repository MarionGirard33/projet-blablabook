...
export default function ProfilePage({ userId }: { userId: number }) {
  ...
  {/* Carré principal */}
  <div className="w-full border border-black rounded-lg bg-gray-50 p-6 flex flex-col justify-between h-[85%] mt-8">
...
<div className="grid grid-cols-[auto_1fr] gap-x-4 gap-y-2 px-4">
  ...
  <span className="tracking-widest">••••••••</span>
    ...
    <button
      ...
      className="w-full bg-red-600 text-white py-3 rounded hover:bg-red-700 transition mt-4"
    >
